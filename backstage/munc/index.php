    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="munc2015.php">北航模联网站后台管理系统</a>
        </div>
    ...
    <div class="row">
      <div class="col-md-10 col-md-offset-1">
        <div class="well">
          ...
          <p>添加链接：&lt;a href="http://buaamun.sinaapp.com/"&gt;<a href="http://buaamun.sinaapp.com/">此处为对链接的描述</a>&lt;/a&gt;</p>
        </div>
      </div>
    </div>
        ...
        <div class="well row">
          ...
          <form>
            ...
            <div class="form-group has-feedback form-type col-md-4">
              <label class="control-label">要设置的网页内容</label>
              <select class="form-control title">
                <option value="1">大会首页-最新动态</option>
                <option value="2">大会邀请函</option>
                <option value="3">第一轮公告</option>
                <option value="4">第二轮公告</option>
                <option value="5">交通指南</option>
                <option value="6">住宿指南</option>
                <option value="7">饮食指南</option>
                <option value="8">委员会介绍</option>
                <option value="9">注册说明</option>
              </select>
            </div>
            ...
            <div class="col-md-12">
              <center><button type="button" id="submit" class="btn btn-success btn-lg">提交</button></center>
            </div>
